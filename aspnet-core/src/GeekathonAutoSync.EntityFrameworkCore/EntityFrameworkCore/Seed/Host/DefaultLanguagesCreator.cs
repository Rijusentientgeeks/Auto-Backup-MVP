...
namespace GeekathonAutoSync.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = GeekathonAutoSyncConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(GeekathonAutoSyncDbContext context)
        {
            _context = context;
        }
