...
{
    public abstract class GeekathonAutoSyncWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GeekathonAutoSyncWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GeekathonAutoSyncWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GeekathonAutoSyncDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GeekathonAutoSyncDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GeekathonAutoSyncDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GeekathonAutoSyncDbContext, Task<T>> func)
        {
            T result;
